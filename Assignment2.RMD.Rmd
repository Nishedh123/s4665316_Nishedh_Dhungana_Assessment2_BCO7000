...
happymeals %>% 
  ...
  arrange(family_income, sort= TRUE)%>%
  kable()
...
#This data set only shows 3 variables now and they are ID, Type and Value and has been arranged according to side, pie and dessert respectively.
```
...
rf1 <- randomForest(family_income ~ us_region + gender + age, data = happymeals, na.action = na.omit)

print (rf1)


rf2 <- randomForest(family_income ~ gender + age, data = happymeals, na.action = na.omit)

print (rf2)

#The first, second and third model have estimate of error rate of 86.68%, 82.68% and 81.66% respectively, and out of 3 models compared model 3 has less error rate which is better than the other models.
